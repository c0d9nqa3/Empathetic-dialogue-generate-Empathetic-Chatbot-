...
#from torch.utils.data import Dataset, DataLoadera
...
def set_args():
    ...
    parser.add_argument('--model_path', default='ChitChat_model/model_epoch40_50w', type=str, required=False, help='对话模型路径')
...
def main(text):
    ...
    model = GPT2LMHeadModel.from_pretrained('ChitChat_model/model_epoch40_50w')
